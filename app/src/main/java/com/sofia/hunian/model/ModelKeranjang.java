...
public class ModelKeranjang {
    ...
    int id_keranjang, id_hunian, id_user;
    String created_by, created_date, updated_by, updated_date;

    public ModelKeranjang(int id_keranjang, int id_hunian, int id_user, String created_by, String created_date, String updated_by, String updated_date) {
