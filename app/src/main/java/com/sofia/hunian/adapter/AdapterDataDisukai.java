...
public class AdapterDataDisukai extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<ModelHunian> dataItemList;

    public AdapterDataDisukai(List<ModelHunian> dataItemList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.z_disukai, parent, false);
