...
public class AdapterLaporanHunianKeluar extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<ModelHunianKeluar> dataItemList;
    List<ModelHunian> listHunian;

    public AdapterLaporanHunianKeluar(List<ModelHunianKeluar> dataItemList, List<ModelHunian> listHunian) {
